...
export const DETAILED_SERVICES: DetailedServiceData[] = [
  ...
  },
  {
    ...
    relatedServiceIds: ['construction-pm', 'immersive-vr', 'home-design'],
    seo: {
  ...
  },
  {
    ...
    overview: {
      ...
      problemSolved: 'Static renderings offer fixed camera angles, but clients cannot walk around corners, test natural eye level, or experience how adjacent rooms feel in sequence.',
      nakshaApproach: 'We compile optimized 3D scenes with physically-based materials and real-time lighting, enabling free navigation across desktop, mobile, and VR display platforms.',
      aecWorkflowValue: 'Delivers instantaneous spatial comprehension for non-technical stakeholders, eliminating guesswork and accelerating project approvals.'
    },
    benefits: [
      {
        title: 'Human-Scale Spatial Understanding',
        description: 'Stand inside unbuilt rooms and evaluate proportions from exact eye height rather than top-down plan views.',
        icon: 'User'
      },
      {
        title: 'Immersive Design Review',
        description: 'Explore room transitions, hallway widths, door clearances, and window sightlines in seamless motion.',
        icon: 'Eye'
      },
      {
        title: 'Stakeholder Communication',
        description: 'Unite investors, buyers, architects, and end-users around a shared interactive visual experience.',
        icon: 'Users'
      },
      {
        title: 'Dynamic Material & Light Exploration',
        description: 'Switch between natural daylight and night lighting options in real-time while navigating.',
        icon: 'Sliders'
      }
    ],
    detailedDeliverables: [
      {
        ...
        description: 'Self-guided interactive 3D environments allowing smooth navigation through interior and exterior project zones.',
        outputFormat: 'Executable & Web-Interactive Formats'
      },
      {
        title: 'Human-Scale Spatial Perspective Review',
        description: 'Configured eye-level viewpoints designed to reflect authentic human stature and peripheral vision inside rooms.',
        outputFormat: '1:1 Scale Spatial Preview'
      },
      {
        title: 'Material & Lighting Exploration Environments',
        description: 'Interactive scenes configured with toggleable material options and daylight-to-dusk lighting transitions.',
        outputFormat: 'Real-time Interactive Scene'
      },
      {
        title: 'Platform-Tailored Interactive Formats',
        description: 'Optimized build packages for desktop workstations, web browser streaming, and immersive headsets.',
        outputFormat: 'Multi-Platform VR Formats'
      }
    ],
    workflow: [
      {
        ...
        description: 'Audit 3D BIM geometry and select key walkthrough routes, key points of interest, and target viewing devices.',
      ...
      },
      {
        step: '04',
        title: 'REFINE',
        subtitle: 'Material Tuning & UI Integration',
        description: 'Apply high-fidelity physical materials, refine light bounces, and embed interactive hotspot annotations.',
  ...
  },
  {
    ...
    overview: {
      definition: '3D Naksha Construction Project Management visualization provides sequence modeling and milestone coordination graphics to illustrate how a project assembles over time.',
      problemSolved: 'Complex construction phasing schedules (Gantt charts) can be difficult to translate into physical spatial site arrangements for sub-contractors and non-technical stakeholders.',
      nakshaApproach: 'We combine BIM geometry with construction phase milestones to generate clear 3D visual sequences that showcase site access, foundation stages, framing progress, and enclosure.',
      aecWorkflowValue: 'Enhances pre-construction communication, aligns contractors on milestone expectations, and supports clear stakeholder reporting.'
    },
    benefits: [
      {
        title: 'Visual Sequence Phasing',
        description: 'Understand how structural framing, envelope cladding, and interior fit-out progress phase by phase.',
        icon: 'Calendar'
      },
      {
        title: 'Site Milestone Coordination',
        description: 'Communicate major milestone targets to site supervisors and contractors using 3D visual representations.',
        icon: 'Flag'
      },
      {
        title: 'Pre-Construction Clarity',
        description: 'Identify staging bottlenecks, access constraints, and assembly logic before site mobilization.',
        icon: 'ShieldCheck'
      },
      {
        title: 'Stakeholder Alignment',
        description: 'Keep investors, client representatives, and management teams informed with clear visual progress reports.',
        icon: 'Users2'
      }
    ],
    detailedDeliverables: [
      {
        title: 'Visual Construction Sequence Phasing',
        description: 'Phase-by-phase 3D visual graphics demonstrating structural assembly, concrete pours, envelope enclosure, and roof installation.',
        outputFormat: '3D Phasing Graphic Set'
      },
      {
        title: 'Site Milestone Coordination Visuals',
        description: 'Milestone target visual graphics illustrating the intended state of completion at key project intervals.',
        outputFormat: 'Milestone Target Diagrams'
      },
      {
        title: 'Stakeholder Visual Progress Support',
        description: 'Presentation graphics comparing target 3D milestone geometry against actual site progress snapshots.',
        outputFormat: 'Progress Alignment Package'
      },
      {
        title: 'Pre-Construction Coordination Reviews',
        description: 'Spatial review briefings identifying crane swing paths, material laydown zones, and site access routes in 3D.',
        outputFormat: 'Pre-Con Visual Briefing'
      }
    ],
    workflow: [
      {
