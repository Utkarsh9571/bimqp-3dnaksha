...
export const WhatsAppButton: React.FC<WhatsAppButtonProps> = ({
  ...
  return (
    <div className={`fixed bottom-6 left-6 z-40 flex items-center group ${className}`}>
